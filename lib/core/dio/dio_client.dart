...
import 'package:posts_app/core/dio/error_model.dart';
...
class DioClient {
  ...
  final String _devBaseURL = "https://jsonplaceholder.typicode.com/";
...
Future<Object?> delete(
    ...
    if (interNetaAvailale) {
      try {
        Response response = await _dio.delete(fullURL ?? url,);
        if (isLoading) {
          Constants.hideLoadingOrNavBack();
        }
